...
PANEL_PATH = BASE_DIR / "sp500_stock_panel.csv"
SECTOR_RETURNS_PATH = BASE_DIR / "sector_returns.csv"
...
FORMAT_EXPORTS = st.sidebar.checkbox("Format CSV exports (rounding) — not recommended", value=False)
